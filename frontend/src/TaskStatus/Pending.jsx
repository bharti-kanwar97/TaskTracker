...
const {handleDelete} = useDeleteTask()
  ...
  return (
    <div className=" flex justify-center items-center ">
      ...
      <div
        key={task._id}
       className="grid grid-cols-2 sm:grid-cols-4 text-center bg-gray-100 dark:bg-[#131e3b] font-semibold p-3 rounded-lg"
      >
        <span className="w-full py-2 text-[15px] font-medium dark:text-white text-left">{task.taskName}</span>
