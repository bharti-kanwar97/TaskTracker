...
function Pending() {
  ...
  const {currentTasks,handlePageClick,pageCount} = usePagination(pendingTask)
    ...
    <div className=" flex justify-center items-center ">
      <div className="w-[98%] mx-auto px-8 py-2 relative min-h-[537.6px]">
        {!currentTasks.length ? (
            ...
            <div className=" grid grid-cols-4 text-center bg-neutral-800 dark:bg-[#0B1223] dark:text-white text-gray-200 font-semibold  py-3 px-7 rounded-t-[10px]">
      ...
      <div
        key={task._id}
        className=" grid grid-cols-4 text-center  border-b-1 border-neutral-500 px-4 py-2 text-black bg-gray-100 dark:bg-[#131e3b]"
      >
        <span className="w-full py-2 text-[15px] font-medium dark:text-white text-center">{task.taskName}</span>
